...
podman tag ${SENSOR_IMAGE}:${VER_TAG}_${DATE_TAG} ${SENSOR_IMAGE}:${LATEST_TAG}
...
podman tag ${PROCESSOR_IMAGE}:${VER_TAG}_${DATE_TAG} ${PROCESSOR_IMAGE}:${LATEST_TAG}
...
podman tag ${DOWNLINKER_IMAGE}:${VER_TAG}_${DATE_TAG} ${DOWNLINKER_IMAGE}:${LATEST_TAG}
...
podman tag ${RECEIVER_IMAGE}:${VER_TAG}_${DATE_TAG} ${RECEIVER_IMAGE}:${LATEST_TAG}
...
podman tag ${FORWARDER_IMAGE}:${VER_TAG}_${DATE_TAG} ${FORWARDER_IMAGE}:${LATEST_TAG}
...
podman tag ${S3UPLOADER_IMAGE}:${VER_TAG}_${DATE_TAG} ${S3UPLOADER_IMAGE}:${LATEST_TAG}
